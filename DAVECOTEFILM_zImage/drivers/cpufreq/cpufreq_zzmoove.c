...
#elif defined(CONFIG_POWERSUSPEND) || defined(CONFIG_POWERSUSPEND)
...
#endif /* defined(CONFIG_HAS_EARLYSUSPEND)... */
{
	...
	* sampling_rate_asleep;							// ZZ: set sampling rate for sleep
	...
	scaling_up_block_cycles_count = 0;
#ifdef ZZMOOVE_DEBUG
	pr_info("[zzmoove] Suspend function executed.\n");
#endif /* ZZMOOVE_DEBUG */
}
...
#ifdef ZZMOOVE_DEBUG
	pr_info("[zzmoove] Resume function executed.\n");
#endif /* ZZMOOVE_DEBUG */
}
...
#elif defined(CONFIG_POWERSUSPEND) && !defined (DISABLE_POWER_MANAGEMENT) || defined(CONFIG_POWERSUSPEND) && !defined (DISABLE_POWER_MANAGEMENT)
